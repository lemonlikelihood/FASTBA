...
bool decompose_homography(
    const Matrix3d &H, Matrix3d &R1, Matrix3d &R2, Vector3d &T1, Vector3d &T2, Vector3d &n1,
    Vector3d &n2) {
...
inline Matrix3d
solve_homography_normalized(const std::array<Vector2d, 4> &pa, const std::array<Vector2d, 4> &pb) {
...
inline Matrix3d
solve_homography_normalized(const std::vector<Vector2d> &pa, const std::vector<Vector2d> &pb) {
...
Matrix3d solve_homography_4pt(
    const std::array<Vector2d, 4> &points1, const std::array<Vector2d, 4> &points2) {
...
Matrix3d
solve_homography(const std::vector<Vector2d> &points1, const std::vector<Vector2d> &points2) {
    static const double sqrt2 = sqrt(2.0);
