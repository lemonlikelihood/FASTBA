...
private:
    ...
    static void make_sample_impl(
        Data &&data, Sample &&sample, size_t idata, size_t isample, std::index_sequence<I...>) {
    ...
    static void make_sample(Data &&data, Sample &&sample, size_t idata, size_t isample) {
        make_sample_impl(
            std::forward<Data>(data), std::forward<Sample>(sample), idata, isample,
