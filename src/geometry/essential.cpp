...
public:
    ...
    Polynomial(const Matrix<double, 20, 1> &coeffcients) : v(coeffcients) {}

public:
    Polynomial() : Polynomial(Matrix<double, 20, 1>::Zero()) {}
    ...
    Polynomial operator*(const Polynomial &b) const {
        ...
        r.v[YZZ] = v[I] * b.v[YZZ] + v[Z] * b.v[YZ] + v[Y] * b.v[ZZ] + v[ZZ] * b.v[Y]
                   + v[YZ] * b.v[Z] + v[YZZ] * b.v[I];
        r.v[XZZ] = v[I] * b.v[XZZ] + v[Z] * b.v[XZ] + v[X] * b.v[ZZ] + v[ZZ] * b.v[X]
                   + v[XZ] * b.v[Z] + v[XZZ] * b.v[I];
        r.v[YYZ] = v[I] * b.v[YYZ] + v[Z] * b.v[YY] + v[Y] * b.v[YZ] + v[YZ] * b.v[Y]
                   + v[YY] * b.v[Z] + v[YYZ] * b.v[I];
        r.v[XYZ] = v[I] * b.v[XYZ] + v[Z] * b.v[XY] + v[Y] * b.v[XZ] + v[X] * b.v[YZ]
                   + v[YZ] * b.v[X] + v[XZ] * b.v[Y] + v[XY] * b.v[Z] + v[XYZ] * b.v[I];
        r.v[XXZ] = v[I] * b.v[XXZ] + v[Z] * b.v[XX] + v[X] * b.v[XZ] + v[XZ] * b.v[X]
                   + v[XX] * b.v[Z] + v[XXZ] * b.v[I];
        r.v[YYY] = v[I] * b.v[YYY] + v[Y] * b.v[YY] + v[YY] * b.v[Y] + v[YYY] * b.v[I];
        r.v[XYY] = v[I] * b.v[XYY] + v[Y] * b.v[XY] + v[X] * b.v[YY] + v[YY] * b.v[X]
                   + v[XY] * b.v[Y] + v[XYY] * b.v[I];
        r.v[XXY] = v[I] * b.v[XXY] + v[Y] * b.v[XX] + v[X] * b.v[XY] + v[XY] * b.v[X]
                   + v[XX] * b.v[Y] + v[XXY] * b.v[I];
        r.v[XXX] = v[I] * b.v[XXX] + v[X] * b.v[XX] + v[XX] * b.v[X] + v[XXX] * b.v[I];

        return r;
    }

    const Matrix<double, 20, 1> &coeffcients() const { return v; }
};
...
inline Matrix<double, 9, 4> generate_nullspace_basis(
    const std::array<Vector2d, 5> &points1, const std::array<Vector2d, 5> &points2) {
    Matrix<double, 5, 9> A;
...
std::vector<Matrix3d> solve_essential_5pt(
    const std::array<Vector2d, 5> &points1, const std::array<Vector2d, 5> &points2) {
